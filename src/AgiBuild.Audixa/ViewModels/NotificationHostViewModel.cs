...
public partial class NotificationHostViewModel : ViewModelBase
{
    ...
    public NotificationHostViewModel(INotificationService notifications)
    {
        ...
        _notifications.ToastRaised += (_, toast) => Toasts.Add(new ToastViewModel(toast.Title, toast.Message, toast.Icon ?? "✅"));
...
public sealed record ToastViewModel(string Title, string Message, string Icon = "✅");
